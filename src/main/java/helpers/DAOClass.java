...
public class DAOClass {
    private static final Log logger = LogFactory.getLog(DAOClass.class);
    ...
    public DAOClass() throws SQLException {
        ...
        connection = DriverManager.getConnection(connectionString, "DA", "");
    }
    ...
    public void writeEvent(EventClass event) throws SQLException {
